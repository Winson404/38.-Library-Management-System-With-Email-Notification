     ...
     <!--  <div class="preloader flex-column justify-content-center align-items-center">
      ...
      <!-- <nav class="main-header navbar navbar-expand navbar-dark"> -->
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <?php
          $get = mysqli_query($conn, "SELECT *, borrowed_books.created_at AS date_borrowed FROM borrowed_books JOIN books ON borrowed_books.book_ID=books.book_ID JOIN users ON borrowed_books.user_Id=users.user_Id WHERE borrowed_books.status=0");
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
              <span class="dropdown-item dropdown-header">
                <?php
                $message = ($count < 1) ? 'No pending borrowed book' : ($count == 1 ? $count . ' pending borrowed book' : $count . ' pending borrowed books');
                echo $message;
                ?>
              </span>
              <div class="dropdown-divider"></div>
              ...
              ?>
              <a href="#" class="dropdown-item">
                <i class="fa-solid fa-circle-info mr-2"></i> <?= $r_count['firstname'].' '.$r_count['lastname']; ?>
                <span class="float-right text-muted text-sm"><?php echo $r_count['date_borrowed']; ?></span>
              </a>
              <br>
              <div class="dropdown-divider"></div>
              <?php
              ...
              <a type="button" href="borrowed_book.php" class="dropdown-item dropdown-footer" <?php echo (mysqli_num_rows($get) == 0) ? 'style="display: none;"' : ''; ?>>
                <?php echo (mysqli_num_rows($get) == 1) ? 'See Now' : 'See All'; ?>
              </a>
            </div>
          </li>
