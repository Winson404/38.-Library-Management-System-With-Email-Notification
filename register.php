                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                          <div class="row">
                              ...
                              <div class="col-lg-4 col col-md-6 col-sm-6 col-12" id="deptGroup" style="display: none;">
                                  <div class="form-group">
                              ...
                              <div class="col-lg-4 col col-md-6 col-sm-6 col-12" id="yrLvlGroup" style="display: none;">
                                  <div class="form-group">
                                      <span class="text-dark"><b>Year Level</b></span>
                                      <input type="text" class="form-control" placeholder="Year Level" name="yr_lvl" id="yr_lvl" required>
                                  </div>
                              </div>
                              <div class="col-lg-4 col-md-4 col-sm-12 col-12" id="teacherMajorGroup" style="display: none;">
                                  <div class="form-group">
                                      <span class="text-dark"><b>Teacher's major</b></span>
                                      <input type="text" class="form-control" placeholder="Teacher's major" name="teacher_major" id="teacher_major" required>
                                  </div>
                              </div>
                          </div>
                        </div>
...
<script>
    $(document).ready(function () {
        ...
        function updateForm() {
            ...
            if (userType === 'Student') {
                $('#deptGroup, #yrLvlGroup').show();
                $('#dept, #yr_lvl').attr('required', 'required');
