<title>LAKASA | Teachers records</title>
<?php
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Teachers records</li>
          </ol>
        </div>
      </div>
    </div>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
                ...
                <a class="btn btn-dark float-sm-right m-1 btn-sm" href="teachers.php"><i class="fa-solid fa-backward"></i> Back</a>
            </div>
            <div class="card-body">
              <div class="container"id="printElement">
                <div class="row invoice-info d-flex p-0 m-0" style="line-height: 18px;">
                  ...
                  <div class="col-12">
                    <p class="text-center text-bold">Registered Teachers</p>
