<title>LAKASA | Student info</title>
<?php 
      ...
      <div class="col-md-12">
        <div class="card card-primary">
          ...
          <div class="card-footer">
            <a href="students.php" class="btn btn-secondary"><i class="fa-solid fa-backward"></i> Back</a>
            <a href="students_mgmt.php?page=<?php echo $row['user_Id']; ?>" class="btn btn-info float-right"><i class="fas fa-pencil-alt"></i> Edit</a>
          </div>
        </div>
      </div>
    </div>
