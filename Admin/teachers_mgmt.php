<title>LAKASA | Manage Teacher</title>
<?php 
        ...
        <form action="process_save.php" method="POST" enctype="multipart/form-data">
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
              <div class="row">
                  ...
                  <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                      <div class="form-group">
                        <span class="text-dark"><b>Teacher's major</b></span>
                        <input type="text" class="form-control"  placeholder="Teacher's major" name="teacher_major" required>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-10 col-md-10 col-sm-9 col-12">
                  <div class="form-group">
                    <span class="text-dark"><b>Teacher's photo</b></span>
                    <div class="input-group">
            ...
            <div class="card-footer">
              <a href="teachers.php" class="btn btn-secondary"><i class="fa-solid fa-backward"></i> Cancel</a>
              <button type="submit" class="btn btn-primary float-right" name="create_teacher" id="submit_button"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
            </div>
          </div>
        </form>
      </div>
      ...
      <div class="col-md-12">
        <form action="process_update.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="card card-primary card-outline">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                  <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                      <div class="form-group">
                        <span class="text-dark"><b>Teacher's major</b></span>
                        <input type="text" class="form-control"  placeholder="Teacher's major" name="teacher_major" value="<?php echo $row['teacher_major']; ?>" required>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="card-footer">
              <a href="teachers.php" class="btn btn-secondary"><i class="fa-solid fa-backward"></i> Cancel</a>
              <button type="submit" class="btn btn-primary float-right" name="update_teacher" id="submit_button"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
            </div>
          </div>
        </form>
      </div>
