<title>LAKASA | Teacher info</title>
<?php 
      ...
      <div class="col-md-12">
        <div class="card card-primary">
          ...
          <div class="card-body">
              ...
              <div class="col-lg-9 col-md-6 col-12">
                <div class="row">
                  ...
                  <div class="col-lg-5 col-md-5 col-sm-12 col-12">
                    <div class="form-group">
                      <small class="text-muted"><b>Teacher's Major:</b></small>
                      <h6><?php echo $row['teacher_major']; ?></h6>
                    </div>
                  </div>
                  <div class="col-4">
                    <div class="form-group">
            ...
            <div class="row p-2">
              <div class="col-lg-12 mt-3 mb-2 col-md-12 col-sm-12 col-12">
                <a class="h5 text-primary"><b>Teacher address</b></a>
                <div class="dropdown-divider"></div>
              </div>
              <div class="col-lg-12 col-md-6 col-12">
                <div class="row">
          ...
          <div class="card-footer">
            <a href="teachers.php" class="btn btn-secondary"><i class="fa-solid fa-backward"></i> Back</a>
            <a href="teachers_mgmt.php?page=<?php echo $row['user_Id']; ?>" class="btn btn-info float-right"><i class="fas fa-pencil-alt"></i> Edit</a>
          </div>
        </div>
      </div>
    </div>
