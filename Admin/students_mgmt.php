<title>LAKASA | Manage Student</title>
<?php 
        ...
        <form action="process_save.php" method="POST" enctype="multipart/form-data">
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
              <div class="row">
                  ...
                  <div class="row">
                    <div class="col-lg-4 col col-md-6 col-sm-6 col-12">
                      <div class="form-group">
                        <span class="text-dark"><b>Department</b></span>
                    ...
                    <div class="col-lg-4 col col-md-6 col-sm-6 col-12">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control"  placeholder="Year Level" name="yr_lvl" required>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-10 col-md-10 col-sm-9 col-12">
                  <div class="form-group">
                    <span class="text-dark"><b>Student's photo</b></span>
                    <div class="input-group">
            ...
            <div class="card-footer">
              <a href="students.php" class="btn btn-secondary"><i class="fa-solid fa-backward"></i> Cancel</a>
              <button type="submit" class="btn btn-primary float-right" name="create_student" id="submit_button"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
            </div>
          </div>
        </form>
      </div>
      ...
      <div class="col-md-12">
        <form action="process_update.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="card card-primary card-outline">
                  ...
                  <div class="row">
                    <div class="col-lg-4 col col-md-6 col-sm-6 col-12">
                      <div class="form-group">
                        ...
                        <select class="form-control" name="dept" required>
                          <option selected disabled value="">Select department</option>
                          <option value="Department 1" <?php if($row['dept'] == 'Department 1') { echo 'selected'; } ?>>Department 1</option>
                          <option value="Department 2" <?php if($row['dept'] == 'Department 2') { echo 'selected'; } ?>>Department 2</option>
                          <option value="Department 3" <?php if($row['dept'] == 'Department 3') { echo 'selected'; } ?>>Department 3</option>
                        </select>
                      </div>
                    </div>
                    <div class="col-lg-4 col col-md-6 col-sm-6 col-12">
                      <div class="form-group">
                        <span class="text-dark"><b>Year Level</b></span>
                        <input type="text" class="form-control"  placeholder="Year Level" name="yr_lvl" value="<?php echo $row['yr_lvl']; ?>" required>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="card-footer">
              <a href="students.php" class="btn btn-secondary"><i class="fa-solid fa-backward"></i> Cancel</a>
              <button type="submit" class="btn btn-primary float-right" name="update_student" id="submit_button"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
            </div>
          </div>
        </form>
      </div>
